...
import { HelpdeskCards } from './src/list/HelpdeskCards';
...
addCustomElement('temba-counter', Counter);
...
addCustomElement('temba-shortcut-list', ShortcutContentList);
addCustomElement('temba-helpdesk-cards', HelpdeskCards);
addCustomElement('temba-field-list', FieldList);
addCustomElement('temba-trigger-list', TriggerList);
addCustomElement('temba-broadcast-list', BroadcastList);
addCustomElement('temba-call-list', CallList);
...
addCustomElement('temba-markdown-edit', MarkdownEditor);
